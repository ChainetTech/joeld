...
const contractAddress = "0xE1970159Fdd5D7b905EC20DFCEc9C8389148F97e";
  ...
  return (
    ...
    <>
      <div className="container">
        ...
        <p class="footer">Powered by <a class="ref-link" href="http://github.com/chainetTech/" target="_blank" rel="noopener noreferrer">Chainet Tech</a></p>
        {data.map((item, index) => (
